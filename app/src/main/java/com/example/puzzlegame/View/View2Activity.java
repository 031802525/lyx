...
public class View2Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.fengjing23_01,R.mipmap.fengjing23_02,R.mipmap.fengjing23_03,
            R.mipmap.fengjing23_04,R.mipmap.fengjing23_05,R.mipmap.fengjing23_06,R.mipmap.fengjing23_07,R.mipmap.fengjing23_08,
            R.mipmap.fengjing23_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(View2Activity.this, View3Activity.class);
