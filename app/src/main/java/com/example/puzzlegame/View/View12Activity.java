...
public class View12Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.fengjing123_01,R.mipmap.fengjing123_02,R.mipmap.fengjing123_03,
            R.mipmap.fengjing123_04,R.mipmap.fengjing123_05,R.mipmap.fengjing123_06,R.mipmap.fengjing123_07,R.mipmap.fengjing123_08,
            R.mipmap.fengjing123_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(View12Activity.this, ViewM1Activity.class);
