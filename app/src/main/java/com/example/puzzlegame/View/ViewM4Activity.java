...
public class ViewM4Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.fengjingsi4_01, R.mipmap.fengjingsi4_02, R.mipmap.fengjingsi4_03,
            R.mipmap.fengjingsi4_04, R.mipmap.fengjingsi4_05, R.mipmap.fengjingsi4_06, R.mipmap.fengjingsi4_07, R.mipmap.fengjingsi4_08,
            R.mipmap.fengjingsi4_09, R.mipmap.fengjingsi4_10, R.mipmap.fengjingsi4_11, R.mipmap.fengjingsi4_12, R.mipmap.fengjingsi4_13,
            R.mipmap.fengjingsi4_14, R.mipmap.fengjingsi4_15, R.mipmap.fengjingsi4_16};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(ViewM4Activity.this, ViewM5Activity.class);
