...
public class View8Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.fengjing83_01,R.mipmap.fengjing83_02,R.mipmap.fengjing83_03,
            R.mipmap.fengjing83_04,R.mipmap.fengjing83_05,R.mipmap.fengjing83_06,R.mipmap.fengjing83_07,R.mipmap.fengjing83_08,
            R.mipmap.fengjing83_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(View8Activity.this, View9Activity.class);
