...
public class ViewM9Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.fengjing94_01, R.mipmap.fengjing94_02, R.mipmap.fengjing94_03,
            R.mipmap.fengjing94_04, R.mipmap.fengjing94_05, R.mipmap.fengjing94_06, R.mipmap.fengjing94_07, R.mipmap.fengjing94_08,
            R.mipmap.fengjing94_09, R.mipmap.fengjing94_10, R.mipmap.fengjing94_11, R.mipmap.fengjing94_12, R.mipmap.fengjing94_13,
            R.mipmap.fengjing94_14, R.mipmap.fengjing94_15, R.mipmap.fengjing94_16};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(ViewM9Activity.this, ViewM10Activity.class);
