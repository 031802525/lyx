...
public class ViewM3Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.fengjing34_01, R.mipmap.fengjing34_02, R.mipmap.fengjing34_03,
            R.mipmap.fengjing34_04, R.mipmap.fengjing34_05, R.mipmap.fengjing34_06, R.mipmap.fengjing34_07, R.mipmap.fengjing34_08,
            R.mipmap.fengjing34_09, R.mipmap.fengjing34_10, R.mipmap.fengjing34_11, R.mipmap.fengjing34_12, R.mipmap.fengjing34_13,
            R.mipmap.fengjing34_14, R.mipmap.fengjing34_15, R.mipmap.fengjing34_16};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(ViewM3Activity.this, ViewM4Activity.class);
