...
public class View3Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.fengjing33_01,R.mipmap.fengjing33_02,R.mipmap.fengjing33_03,
            R.mipmap.fengjing33_04,R.mipmap.fengjing33_05,R.mipmap.fengjing33_06,R.mipmap.fengjing33_07,R.mipmap.fengjing33_08,
            R.mipmap.fengjing33_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(View3Activity.this, View4Activity.class);
