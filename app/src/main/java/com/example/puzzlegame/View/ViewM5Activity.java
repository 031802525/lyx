...
public class ViewM5Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.fengjing54_01, R.mipmap.fengjing54_02, R.mipmap.fengjing54_03,
            R.mipmap.fengjing54_04, R.mipmap.fengjing54_05, R.mipmap.fengjing54_06, R.mipmap.fengjing54_07, R.mipmap.fengjing54_08,
            R.mipmap.fengjing54_09, R.mipmap.fengjing54_10, R.mipmap.fengjing54_11, R.mipmap.fengjing54_12, R.mipmap.fengjing54_13,
            R.mipmap.fengjing54_14, R.mipmap.fengjing54_15, R.mipmap.fengjing54_16};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(ViewM5Activity.this, ViewM6Activity.class);
