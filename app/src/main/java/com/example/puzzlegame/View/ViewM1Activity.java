...
public class ViewM1Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.fengjing14_01, R.mipmap.fengjing14_02, R.mipmap.fengjing14_03,
            R.mipmap.fengjing14_04, R.mipmap.fengjing14_05, R.mipmap.fengjing14_06, R.mipmap.fengjing14_07, R.mipmap.fengjing14_08,
            R.mipmap.fengjing14_09, R.mipmap.fengjing14_10, R.mipmap.fengjing14_11, R.mipmap.fengjing14_12, R.mipmap.fengjing14_13,
            R.mipmap.fengjing14_14, R.mipmap.fengjing14_15, R.mipmap.fengjing14_16};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(ViewM1Activity.this, ViewM2Activity.class);
