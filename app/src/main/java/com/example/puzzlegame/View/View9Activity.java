...
public class View9Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.fengjing93_01,R.mipmap.fengjing93_02,R.mipmap.fengjing93_03,
            R.mipmap.fengjing93_04,R.mipmap.fengjing93_05,R.mipmap.fengjing93_06,R.mipmap.fengjing93_07,R.mipmap.fengjing93_08,
            R.mipmap.fengjing93_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(View9Activity.this, View10Activity.class);
