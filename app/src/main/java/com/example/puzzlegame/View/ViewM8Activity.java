...
public class ViewM8Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.fengjing84_01, R.mipmap.fengjing84_02, R.mipmap.fengjing84_03,
            R.mipmap.fengjing84_04, R.mipmap.fengjing84_05, R.mipmap.fengjing84_06, R.mipmap.fengjing84_07, R.mipmap.fengjing84_08,
            R.mipmap.fengjing84_09, R.mipmap.fengjing84_10, R.mipmap.fengjing84_11, R.mipmap.fengjing84_12, R.mipmap.fengjing84_13,
            R.mipmap.fengjing84_14, R.mipmap.fengjing84_15, R.mipmap.fengjing84_16};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(ViewM8Activity.this, ViewM9Activity.class);
