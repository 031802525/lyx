...
public class View4Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.fengjingsi3_01,R.mipmap.fengjingsi3_02,R.mipmap.fengjingsi3_03,
            R.mipmap.fengjingsi3_04,R.mipmap.fengjingsi3_05,R.mipmap.fengjingsi3_06,R.mipmap.fengjingsi3_07,R.mipmap.fengjingsi3_08,
            R.mipmap.fengjingsi3_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(View4Activity.this, View5Activity.class);
