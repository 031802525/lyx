...
public class ViewM2Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.fengjing24_01, R.mipmap.fengjing24_02, R.mipmap.fengjing24_03,
            R.mipmap.fengjing24_04, R.mipmap.fengjing24_05, R.mipmap.fengjing24_06, R.mipmap.fengjing24_07, R.mipmap.fengjing24_08,
            R.mipmap.fengjing24_09, R.mipmap.fengjing24_10, R.mipmap.fengjing24_11, R.mipmap.fengjing24_12, R.mipmap.fengjing24_13,
            R.mipmap.fengjing24_14, R.mipmap.fengjing24_15, R.mipmap.fengjing24_16};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(ViewM2Activity.this, ViewM3Activity.class);
