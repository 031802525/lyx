...
public class View6Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.fengjing63_01,R.mipmap.fengjing63_02,R.mipmap.fengjing63_03,
            R.mipmap.fengjing63_04,R.mipmap.fengjing63_05,R.mipmap.fengjing63_06,R.mipmap.fengjing63_07,R.mipmap.fengjing63_08,
            R.mipmap.fengjing63_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(View6Activity.this, View7Activity.class);
