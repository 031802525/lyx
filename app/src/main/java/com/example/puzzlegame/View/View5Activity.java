...
public class View5Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.fengjing53_01,R.mipmap.fengjing53_02,R.mipmap.fengjing53_03,
            R.mipmap.fengjing53_04,R.mipmap.fengjing53_05,R.mipmap.fengjing53_06,R.mipmap.fengjing53_07,R.mipmap.fengjing53_08,
            R.mipmap.fengjing53_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(View5Activity.this, View6Activity.class);
