...
public class View10Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.fengjing103_01,R.mipmap.fengjing103_02,R.mipmap.fengjing103_03,
            R.mipmap.fengjing103_04,R.mipmap.fengjing103_05,R.mipmap.fengjing103_06,R.mipmap.fengjing103_07,R.mipmap.fengjing103_08,
            R.mipmap.fengjing103_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(View10Activity.this, View11Activity.class);
