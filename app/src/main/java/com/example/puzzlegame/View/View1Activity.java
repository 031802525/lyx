...
public class View1Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.fengjing13_01,R.mipmap.fengjing13_02,R.mipmap.fengjing13_03,
            R.mipmap.fengjing13_04,R.mipmap.fengjing13_05,R.mipmap.fengjing13_06,R.mipmap.fengjing13_07,R.mipmap.fengjing13_08,
            R.mipmap.fengjing13_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(View1Activity.this, View2Activity.class);
