...
public class View7Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.fengjing73_01,R.mipmap.fengjing73_02,R.mipmap.fengjing73_03,
            R.mipmap.fengjing73_04,R.mipmap.fengjing73_05,R.mipmap.fengjing73_06,R.mipmap.fengjing73_07,R.mipmap.fengjing73_08,
            R.mipmap.fengjing73_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(View7Activity.this, View8Activity.class);
