...
public class ViewM7Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.fengjing74_01, R.mipmap.fengjing74_02, R.mipmap.fengjing74_03,
            R.mipmap.fengjing74_04, R.mipmap.fengjing74_05, R.mipmap.fengjing74_06, R.mipmap.fengjing74_07, R.mipmap.fengjing74_08,
            R.mipmap.fengjing74_09, R.mipmap.fengjing74_10, R.mipmap.fengjing74_11, R.mipmap.fengjing74_12, R.mipmap.fengjing74_13,
            R.mipmap.fengjing74_14, R.mipmap.fengjing74_15, R.mipmap.fengjing74_16};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(ViewM7Activity.this, ViewM8Activity.class);
