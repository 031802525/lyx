...
public class ViewH8Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.fengjing85_01, R.mipmap.fengjing85_02, R.mipmap.fengjing85_03,
            R.mipmap.fengjing85_04, R.mipmap.fengjing85_05, R.mipmap.fengjing85_06, R.mipmap.fengjing85_07, R.mipmap.fengjing85_08,
            R.mipmap.fengjing85_09, R.mipmap.fengjing85_10, R.mipmap.fengjing85_11, R.mipmap.fengjing85_12, R.mipmap.fengjing85_13,
            R.mipmap.fengjing85_14, R.mipmap.fengjing85_15, R.mipmap.fengjing85_16, R.mipmap.fengjing85_17, R.mipmap.fengjing85_18, R.mipmap.fengjing85_19,
            R.mipmap.fengjing85_20, R.mipmap.fengjing85_21, R.mipmap.fengjing85_22, R.mipmap.fengjing85_23, R.mipmap.fengjing85_24, R.mipmap.fengjing85_25};
...
//        随机排列到指定的控件上
    ...
    private void initView() {
        ...
        bottomIv.setImageResource(R.mipmap.fengjing8);
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(ViewH8Activity.this, ViewH9Activity.class);
