...
public class ViewH4Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.fengjingsi5_01, R.mipmap.fengjingsi5_02, R.mipmap.fengjingsi5_03,
            R.mipmap.fengjingsi5_04, R.mipmap.fengjingsi5_05, R.mipmap.fengjingsi5_06, R.mipmap.fengjingsi5_07, R.mipmap.fengjingsi5_08,
            R.mipmap.fengjingsi5_09, R.mipmap.fengjingsi5_10, R.mipmap.fengjingsi5_11, R.mipmap.fengjingsi5_12, R.mipmap.fengjingsi5_13,
            R.mipmap.fengjingsi5_14, R.mipmap.fengjingsi5_15, R.mipmap.fengjingsi5_16, R.mipmap.fengjingsi5_17, R.mipmap.fengjingsi5_18, R.mipmap.fengjingsi5_19,
            R.mipmap.fengjingsi5_20, R.mipmap.fengjingsi5_21, R.mipmap.fengjingsi5_22, R.mipmap.fengjingsi5_23, R.mipmap.fengjingsi5_24, R.mipmap.fengjingsi5_25};
...
//        随机排列到指定的控件上
    ...
    private void initView() {
        ...
        bottomIv.setImageResource(R.mipmap.fengjingsi);
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(ViewH4Activity.this, ViewH5Activity.class);
