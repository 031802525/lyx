...
public class View11Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.fengjing113_01,R.mipmap.fengjing113_02,R.mipmap.fengjing113_03,
            R.mipmap.fengjing113_04,R.mipmap.fengjing113_05,R.mipmap.fengjing113_06,R.mipmap.fengjing113_07,R.mipmap.fengjing113_08,
            R.mipmap.fengjing113_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(View11Activity.this, View12Activity.class);
