...
public class Star13Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.yangchaoyue3_01,R.mipmap.yangchaoyue3_02,R.mipmap.yangchaoyue3_03,
            R.mipmap.yangchaoyue3_04,R.mipmap.yangchaoyue3_05,R.mipmap.yangchaoyue3_06,R.mipmap.yangchaoyue3_07,R.mipmap.yangchaoyue3_08,
            R.mipmap.yangchaoyue3_09};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_star13);
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(Star13Activity.this, Star14Activity.class);
