...
public class Star9Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.reba3_01,R.mipmap.reba3_02,R.mipmap.reba3_03,
            R.mipmap.reba3_04,R.mipmap.reba3_05,R.mipmap.reba3_06,R.mipmap.reba3_07,R.mipmap.reba3_08,
            R.mipmap.reba3_09};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_star9);
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(Star9Activity.this, Star10Activity.class);
