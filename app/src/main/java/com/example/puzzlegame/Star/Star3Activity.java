...
public class Star3Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.denglun3_01,R.mipmap.denglun3_02,R.mipmap.denglun3_03,
            R.mipmap.denglun3_04,R.mipmap.denglun3_05,R.mipmap.denglun3_06,R.mipmap.denglun3_07,R.mipmap.denglun3_08,
            R.mipmap.denglun3_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(Star3Activity.this, Star4Activity.class);
