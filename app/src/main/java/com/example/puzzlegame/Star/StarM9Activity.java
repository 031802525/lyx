...
public class StarM9Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.reba4_01, R.mipmap.reba4_02, R.mipmap.reba4_03,
            R.mipmap.reba4_04, R.mipmap.reba4_05, R.mipmap.reba4_06, R.mipmap.reba4_07, R.mipmap.reba4_08,
            R.mipmap.reba4_09, R.mipmap.reba4_10, R.mipmap.reba4_11, R.mipmap.reba4_12, R.mipmap.reba4_13,
            R.mipmap.reba4_14, R.mipmap.reba4_15, R.mipmap.reba4_16};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_star_m9);
        initView();
    }
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(StarM9Activity.this, StarM10Activity.class);
