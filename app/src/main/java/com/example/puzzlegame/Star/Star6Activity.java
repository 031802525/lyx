...
public class Star6Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.pengyuchang3_01,R.mipmap.pengyuchang3_02,R.mipmap.pengyuchang3_03,
            R.mipmap.pengyuchang3_04,R.mipmap.pengyuchang3_05,R.mipmap.pengyuchang3_06,R.mipmap.pengyuchang3_07,R.mipmap.pengyuchang3_08,
            R.mipmap.pengyuchang3_09};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_star6);
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(Star6Activity.this, Star7Activity.class);
