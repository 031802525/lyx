...
public class Star4Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.dingyuxi3_01,R.mipmap.dingyuxi3_02,R.mipmap.dingyuxi3_03,
            R.mipmap.dingyuxi3_04,R.mipmap.dingyuxi3_05,R.mipmap.dingyuxi3_06,R.mipmap.dingyuxi3_07,R.mipmap.dingyuxi3_08,
            R.mipmap.dingyuxi3_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(Star4Activity.this, Star5Activity.class);
