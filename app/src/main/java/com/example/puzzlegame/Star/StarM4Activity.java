...
public class StarM4Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.dingyuxi4_01, R.mipmap.dingyuxi4_02, R.mipmap.dingyuxi4_03,
            R.mipmap.dingyuxi4_04, R.mipmap.dingyuxi4_05, R.mipmap.dingyuxi4_06, R.mipmap.dingyuxi4_07, R.mipmap.dingyuxi4_08,
            R.mipmap.dingyuxi4_09, R.mipmap.dingyuxi4_10, R.mipmap.dingyuxi4_11, R.mipmap.dingyuxi4_12, R.mipmap.dingyuxi4_13,
            R.mipmap.dingyuxi4_14, R.mipmap.dingyuxi4_15, R.mipmap.dingyuxi4_16};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_star_m4);
        initView();
    }
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(StarM4Activity.this, StarM5Activity.class);
