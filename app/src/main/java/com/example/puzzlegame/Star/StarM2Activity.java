...
public class StarM2Activity extends AppCompatActivity  implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.cheyinyou4_01, R.mipmap.cheyinyou4_02, R.mipmap.cheyinyou4_03,
            R.mipmap.cheyinyou4_04, R.mipmap.cheyinyou4_05, R.mipmap.cheyinyou4_06, R.mipmap.cheyinyou4_07, R.mipmap.cheyinyou4_08,
            R.mipmap.cheyinyou4_09, R.mipmap.cheyinyou4_10, R.mipmap.cheyinyou4_11, R.mipmap.cheyinyou4_12, R.mipmap.cheyinyou4_13,
            R.mipmap.cheyinyou4_14, R.mipmap.cheyinyou4_15, R.mipmap.cheyinyou4_16};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_star_m2);
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(StarM2Activity.this, StarM3Activity.class);
