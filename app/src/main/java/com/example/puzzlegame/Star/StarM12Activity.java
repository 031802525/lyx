...
public class StarM12Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.xukai4_01, R.mipmap.xukai4_02, R.mipmap.xukai4_03,
            R.mipmap.xukai4_04, R.mipmap.xukai4_05, R.mipmap.xukai4_06, R.mipmap.xukai4_07, R.mipmap.xukai4_08,
            R.mipmap.xukai4_09, R.mipmap.xukai4_10, R.mipmap.xukai4_11, R.mipmap.xukai4_12, R.mipmap.xukai4_13,
            R.mipmap.xukai4_14, R.mipmap.xukai4_15, R.mipmap.xukai4_16};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_star_m12);
        initView();
    }
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(StarM12Activity.this, StarM13Activity.class);
