...
public class StarM10Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.renjialun4_01, R.mipmap.renjialun4_02, R.mipmap.renjialun4_03,
            R.mipmap.renjialun4_04, R.mipmap.renjialun4_05, R.mipmap.renjialun4_06, R.mipmap.renjialun4_07, R.mipmap.renjialun4_08,
            R.mipmap.renjialun4_09, R.mipmap.renjialun4_10, R.mipmap.renjialun4_11, R.mipmap.renjialun4_12, R.mipmap.renjialun4_13,
            R.mipmap.renjialun4_14, R.mipmap.renjialun4_15, R.mipmap.renjialun4_16};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_star_m10);
        initView();
    }
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(StarM10Activity.this, StarM11Activity.class);
