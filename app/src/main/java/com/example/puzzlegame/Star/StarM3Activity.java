...
public class StarM3Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.denglun4_01, R.mipmap.denglun4_02, R.mipmap.denglun4_03,
            R.mipmap.denglun4_04, R.mipmap.denglun4_05, R.mipmap.denglun4_06, R.mipmap.denglun4_07, R.mipmap.denglun4_08,
            R.mipmap.denglun4_09, R.mipmap.denglun4_10, R.mipmap.denglun4_11, R.mipmap.denglun4_12, R.mipmap.denglun4_13,
            R.mipmap.denglun4_14, R.mipmap.denglun4_15, R.mipmap.denglun4_16};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_star_m3);
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(StarM3Activity.this, StarM4Activity.class);
