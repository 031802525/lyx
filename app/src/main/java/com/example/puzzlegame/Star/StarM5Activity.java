...
public class StarM5Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.laiguanlin4_01, R.mipmap.laiguanlin4_02, R.mipmap.laiguanlin4_03,
            R.mipmap.laiguanlin4_04, R.mipmap.laiguanlin4_05, R.mipmap.laiguanlin4_06, R.mipmap.laiguanlin4_07, R.mipmap.laiguanlin4_08,
            R.mipmap.laiguanlin4_09, R.mipmap.laiguanlin4_10, R.mipmap.laiguanlin4_11, R.mipmap.laiguanlin4_12, R.mipmap.laiguanlin4_13,
            R.mipmap.laiguanlin4_14, R.mipmap.laiguanlin4_15, R.mipmap.laiguanlin4_16};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_star_m5);
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(StarM5Activity.this, StarM6Activity.class);
