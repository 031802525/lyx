...
public class StarM13Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.yangchaoyue4_01, R.mipmap.yangchaoyue4_02, R.mipmap.yangchaoyue4_03,
            R.mipmap.yangchaoyue4_04, R.mipmap.yangchaoyue4_05, R.mipmap.yangchaoyue4_06, R.mipmap.yangchaoyue4_07, R.mipmap.yangchaoyue4_08,
            R.mipmap.yangchaoyue4_09, R.mipmap.yangchaoyue4_10, R.mipmap.yangchaoyue4_11, R.mipmap.yangchaoyue4_12, R.mipmap.yangchaoyue4_13,
            R.mipmap.yangchaoyue4_14, R.mipmap.yangchaoyue4_15, R.mipmap.yangchaoyue4_16};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_star_m13);
        initView();
    }
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(StarM13Activity.this, StarM14Activity.class);
