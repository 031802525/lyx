...
public class StarM15Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.zhangyixing4_01, R.mipmap.zhangyixing4_02, R.mipmap.zhangyixing4_03,
            R.mipmap.zhangyixing4_04, R.mipmap.zhangyixing4_05, R.mipmap.zhangyixing4_06, R.mipmap.zhangyixing4_07, R.mipmap.zhangyixing4_08,
            R.mipmap.zhangyixing4_09, R.mipmap.zhangyixing4_10, R.mipmap.zhangyixing4_11, R.mipmap.zhangyixing4_12, R.mipmap.zhangyixing4_13,
            R.mipmap.zhangyixing4_14, R.mipmap.zhangyixing4_15, R.mipmap.zhangyixing4_16};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_star_m15);
        initView();
    }
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(StarM15Activity.this, StarM16Activity.class);
