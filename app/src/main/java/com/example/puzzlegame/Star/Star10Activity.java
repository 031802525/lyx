...
public class Star10Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.renjialun3_01,R.mipmap.renjialun3_02,R.mipmap.renjialun3_03,
            R.mipmap.renjialun3_04,R.mipmap.renjialun3_05,R.mipmap.renjialun3_06,R.mipmap.renjialun3_07,R.mipmap.renjialun3_08,
            R.mipmap.renjialun3_09};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_star10);
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(Star10Activity.this, Star11Activity.class);
