...
public class Star15Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.zhangyixing3_01,R.mipmap.zhangyixing3_02,R.mipmap.zhangyixing3_03,
            R.mipmap.zhangyixing3_04,R.mipmap.zhangyixing3_05,R.mipmap.zhangyixing3_06,R.mipmap.zhangyixing3_07,R.mipmap.zhangyixing3_08,
            R.mipmap.zhangyixing3_09};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_star15);
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(Star15Activity.this, Star16Activity.class);
