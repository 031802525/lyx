...
public class Star11Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.wangdalu3_01,R.mipmap.wangdalu3_02,R.mipmap.wangdalu3_03,
            R.mipmap.wangdalu3_04,R.mipmap.wangdalu3_05,R.mipmap.wangdalu3_06,R.mipmap.wangdalu3_07,R.mipmap.wangdalu3_08,
            R.mipmap.wangdalu3_09};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_star11);
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(Star11Activity.this, Star12Activity.class);
