...
public class Star12Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.xukai3_01,R.mipmap.xukai3_02,R.mipmap.xukai3_03,
            R.mipmap.xukai3_04,R.mipmap.xukai3_05,R.mipmap.xukai3_06,R.mipmap.xukai3_07,R.mipmap.xukai3_08,
            R.mipmap.xukai3_09};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_star12);
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(Star12Activity.this, Star13Activity.class);
