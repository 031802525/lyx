...
public class Star5Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.laiguanlin_01,R.mipmap.laiguanlin_02,R.mipmap.laiguanlin_03,
            R.mipmap.laiguanlin_04,R.mipmap.laiguanlin_05,R.mipmap.laiguanlin_06,R.mipmap.laiguanlin_07,R.mipmap.laiguanlin_08,
            R.mipmap.laiguanlin_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(Star5Activity.this, Star6Activity.class);
