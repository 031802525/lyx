...
public class Star16Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.zuotengjian3_01,R.mipmap.zuotengjian3_02,R.mipmap.zuotengjian3_03,
            R.mipmap.zuotengjian3_04,R.mipmap.zuotengjian3_05,R.mipmap.zuotengjian3_06,R.mipmap.zuotengjian3_07,R.mipmap.zuotengjian3_08,
            R.mipmap.zuotengjian3_09};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_star16);
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(Star16Activity.this, StarM1Activity.class);
