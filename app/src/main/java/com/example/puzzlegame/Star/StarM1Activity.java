...
public class StarM1Activity extends AppCompatActivity  implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.biwenjun4_01, R.mipmap.biwenjun4_02, R.mipmap.biwenjun4_03,
            R.mipmap.biwenjun4_04, R.mipmap.biwenjun4_05, R.mipmap.biwenjun4_06, R.mipmap.biwenjun4_07, R.mipmap.biwenjun4_08,
            R.mipmap.biwenjun4_09, R.mipmap.biwenjun4_10, R.mipmap.biwenjun4_11, R.mipmap.biwenjun4_12, R.mipmap.biwenjun4_13,
            R.mipmap.biwenjun4_14, R.mipmap.biwenjun4_15, R.mipmap.biwenjun4_16};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_star_m1);
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(StarM1Activity.this, StarM2Activity.class);
