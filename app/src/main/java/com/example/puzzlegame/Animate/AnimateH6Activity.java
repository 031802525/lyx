...
public class AnimateH6Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.jingjizhen5_01, R.mipmap.jingjizhen5_02, R.mipmap.jingjizhen5_03,
            R.mipmap.jingjizhen5_04, R.mipmap.jingjizhen5_05, R.mipmap.jingjizhen5_06, R.mipmap.jingjizhen5_07, R.mipmap.jingjizhen5_08,
            R.mipmap.jingjizhen5_09, R.mipmap.jingjizhen5_10, R.mipmap.jingjizhen5_11, R.mipmap.jingjizhen5_12, R.mipmap.jingjizhen5_13,
            R.mipmap.jingjizhen5_14, R.mipmap.jingjizhen5_15, R.mipmap.jingjizhen5_16, R.mipmap.jingjizhen5_17, R.mipmap.jingjizhen5_18, R.mipmap.jingjizhen5_19,
            R.mipmap.jingjizhen5_20, R.mipmap.jingjizhen5_21, R.mipmap.jingjizhen5_22, R.mipmap.jingjizhen5_23, R.mipmap.jingjizhen5_24, R.mipmap.jingjizhen5_25};
...
//        随机排列到指定的控件上
    ...
    private void initView() {
        ...
        bottomIv.setImageResource(R.mipmap.jingjizhen);
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(AnimateH6Activity.this, AnimateH7Activity.class);
