...
public class Animate4Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.huiyuan3_01,R.mipmap.huiyuan3_02,R.mipmap.huiyuan3_03,
            R.mipmap.huiyuan3_04,R.mipmap.huiyuan3_05,R.mipmap.huiyuan3_06,R.mipmap.huiyuan3_07,R.mipmap.huiyuan3_08,
            R.mipmap.huiyuan3_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(Animate4Activity.this, Animate5Activity.class);
