...
public class AnimateM5Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.jide4_01, R.mipmap.jide4_02, R.mipmap.jide4_03,
            R.mipmap.jide4_04, R.mipmap.jide4_05, R.mipmap.jide4_06, R.mipmap.jide4_07, R.mipmap.jide4_08,
            R.mipmap.jide4_09, R.mipmap.jide4_10, R.mipmap.jide4_11, R.mipmap.jide4_12, R.mipmap.jide4_13,
            R.mipmap.jide4_14, R.mipmap.jide4_15, R.mipmap.jide4_16};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(AnimateM5Activity.this, AnimateM6Activity.class);
