...
public class AnimateH11Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.nan_01, R.mipmap.nan_02, R.mipmap.nan_03,
            R.mipmap.nan_04, R.mipmap.nan_05, R.mipmap.nan_06, R.mipmap.nan_07, R.mipmap.nan_08,
            R.mipmap.nan_09, R.mipmap.nan_10, R.mipmap.nan_11, R.mipmap.nan_12, R.mipmap.nan_13,
            R.mipmap.nan_14, R.mipmap.nan_15, R.mipmap.nan_16, R.mipmap.nan_17, R.mipmap.nan_18, R.mipmap.nan_19,
            R.mipmap.nan_20, R.mipmap.nan_21, R.mipmap.nan_22, R.mipmap.nan_23, R.mipmap.nan_24, R.mipmap.nan_25};
...
//        随机排列到指定的控件上
    ...
    private void initView() {
        ...
        bottomIv.setImageResource(R.mipmap.nan);
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(AnimateH11Activity.this, AnimateH12Activity.class);
