...
public class Animate8Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.luren13_01,R.mipmap.luren13_02,R.mipmap.luren13_03,
            R.mipmap.luren13_04,R.mipmap.luren13_05,R.mipmap.luren13_06,R.mipmap.luren13_07,R.mipmap.luren13_08,
            R.mipmap.luren13_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(Animate8Activity.this, Animate9Activity.class);
