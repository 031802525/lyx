...
public class Animate3Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.huazijun3_01,R.mipmap.huazijun3_02,R.mipmap.huazijun3_03,
            R.mipmap.huazijun3_04,R.mipmap.huazijun3_05,R.mipmap.huazijun3_06,R.mipmap.huazijun3_07,R.mipmap.huazijun3_08,
            R.mipmap.huazijun3_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(Animate3Activity.this, Animate4Activity.class);
