...
import com.example.puzzlegame.PassActivity;
import com.example.puzzlegame.R;
import com.example.puzzlegame.Star.StarH2Activity;

public class AnimateH12Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.songtianzhenping5_01, R.mipmap.songtianzhenping5_02, R.mipmap.songtianzhenping5_03,
            R.mipmap.songtianzhenping5_04, R.mipmap.songtianzhenping5_05, R.mipmap.songtianzhenping5_06, R.mipmap.songtianzhenping5_07, R.mipmap.songtianzhenping5_08,
            R.mipmap.songtianzhenping5_09, R.mipmap.songtianzhenping5_10, R.mipmap.songtianzhenping5_11, R.mipmap.songtianzhenping5_12, R.mipmap.songtianzhenping5_13,
            R.mipmap.songtianzhenping5_14, R.mipmap.songtianzhenping5_15, R.mipmap.songtianzhenping5_16, R.mipmap.songtianzhenping5_17, R.mipmap.songtianzhenping5_18, R.mipmap.songtianzhenping5_19,
            R.mipmap.songtianzhenping5_20, R.mipmap.songtianzhenping5_21, R.mipmap.songtianzhenping5_22, R.mipmap.songtianzhenping5_23, R.mipmap.songtianzhenping5_24, R.mipmap.songtianzhenping5_25};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animate_h1);
...
//        随机排列到指定的控件上
    ...
    private void initView() {
        ...
        bottomIv.setImageResource(R.mipmap.songtianzhenping);
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(AnimateH12Activity.this, PassActivity.class);
