...
public class Animate7Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.kenan3_01,R.mipmap.kenan3_02,R.mipmap.kenan3_03,
            R.mipmap.kenan3_04,R.mipmap.kenan3_05,R.mipmap.kenan3_06,R.mipmap.kenan3_07,R.mipmap.kenan3_08,
            R.mipmap.kenan3_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(Animate7Activity.this, Animate8Activity.class);
