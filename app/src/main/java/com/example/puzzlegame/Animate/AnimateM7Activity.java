...
public class AnimateM7Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.kenan4_01, R.mipmap.kenan4_02, R.mipmap.kenan4_03,
            R.mipmap.kenan4_04, R.mipmap.kenan4_05, R.mipmap.kenan4_06, R.mipmap.kenan4_07, R.mipmap.kenan4_08,
            R.mipmap.kenan4_09, R.mipmap.kenan4_10, R.mipmap.kenan4_11, R.mipmap.kenan4_12, R.mipmap.kenan4_13,
            R.mipmap.kenan4_14, R.mipmap.kenan4_15, R.mipmap.kenan4_16};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(AnimateM7Activity.this, AnimateM8Activity.class);
