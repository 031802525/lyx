...
public class Animate6Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.jingjizhen3_01,R.mipmap.jingjizhen3_02,R.mipmap.jingjizhen3_03,
            R.mipmap.jingjizhen3_04,R.mipmap.jingjizhen3_05,R.mipmap.jingjizhen3_06,R.mipmap.jingjizhen3_07,R.mipmap.jingjizhen3_08,
            R.mipmap.jingjizhen3_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(Animate6Activity.this, Animate7Activity.class);
