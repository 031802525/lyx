...
public class AnimateM6Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.jingjizhen4_01, R.mipmap.jingjizhen4_02, R.mipmap.jingjizhen4_03,
            R.mipmap.jingjizhen4_04, R.mipmap.jingjizhen4_05, R.mipmap.jingjizhen4_06, R.mipmap.jingjizhen4_07, R.mipmap.jingjizhen4_08,
            R.mipmap.jingjizhen4_09, R.mipmap.jingjizhen4_10, R.mipmap.jingjizhen4_11, R.mipmap.jingjizhen4_12, R.mipmap.jingjizhen4_13,
            R.mipmap.jingjizhen4_14, R.mipmap.jingjizhen4_15, R.mipmap.jingjizhen4_16};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(AnimateM6Activity.this, AnimateM7Activity.class);
