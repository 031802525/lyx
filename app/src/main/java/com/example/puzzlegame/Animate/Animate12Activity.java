...
public class Animate12Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.songtianzhenping3_01,R.mipmap.songtianzhenping3_02,R.mipmap.songtianzhenping3_03,
            R.mipmap.songtianzhenping3_04,R.mipmap.songtianzhenping3_05,R.mipmap.songtianzhenping3_06,R.mipmap.songtianzhenping3_07,R.mipmap.songtianzhenping3_08,
            R.mipmap.songtianzhenping3_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(Animate12Activity.this, AnimateM1Activity.class);
