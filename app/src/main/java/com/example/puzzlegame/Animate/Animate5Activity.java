...
public class Animate5Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.jide3_01,R.mipmap.jide3_02,R.mipmap.jide3_03,
            R.mipmap.jide3_04,R.mipmap.jide3_05,R.mipmap.jide3_06,R.mipmap.jide3_07,R.mipmap.jide3_08,
            R.mipmap.jide3_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(Animate5Activity.this, Animate6Activity.class);
