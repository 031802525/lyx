...
public class AnimateM3Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.huazijun4_01, R.mipmap.huazijun4_02, R.mipmap.huazijun4_03,
            R.mipmap.huazijun4_04, R.mipmap.huazijun4_05, R.mipmap.huazijun4_06, R.mipmap.huazijun4_07, R.mipmap.huazijun4_08,
            R.mipmap.huazijun4_09, R.mipmap.huazijun4_10, R.mipmap.huazijun4_11, R.mipmap.huazijun4_12, R.mipmap.huazijun4_13,
            R.mipmap.huazijun4_14, R.mipmap.huazijun4_15, R.mipmap.huazijun4_16};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(AnimateM3Activity.this, AnimateM4Activity.class);
