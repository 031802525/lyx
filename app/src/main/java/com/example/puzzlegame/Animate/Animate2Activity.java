...
public class Animate2Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.fubupingci3_01,R.mipmap.fubupingci3_02,R.mipmap.fubupingci3_03,
            R.mipmap.fubupingci3_04,R.mipmap.fubupingci3_05,R.mipmap.fubupingci3_06,R.mipmap.fubupingci3_07,R.mipmap.fubupingci3_08,
            R.mipmap.fubupingci3_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(Animate2Activity.this, Animate3Activity.class);
