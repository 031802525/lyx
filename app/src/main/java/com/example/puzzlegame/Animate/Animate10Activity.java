...
public class Animate10Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.mipmap.maolilan3_01,R.mipmap.maolilan3_02,R.mipmap.maolilan3_03,
            R.mipmap.maolilan3_04,R.mipmap.maolilan3_05,R.mipmap.maolilan3_06,R.mipmap.maolilan3_07,R.mipmap.maolilan3_08,
            R.mipmap.maolilan3_09};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(Animate10Activity.this, Animate11Activity.class);
