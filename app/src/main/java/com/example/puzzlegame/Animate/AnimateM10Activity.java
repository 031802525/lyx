...
public class AnimateM10Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[] image = {R.mipmap.maolilan4_01, R.mipmap.maolilan4_02, R.mipmap.maolilan4_03,
            R.mipmap.maolilan4_04, R.mipmap.maolilan4_05, R.mipmap.maolilan4_06, R.mipmap.maolilan4_07, R.mipmap.maolilan4_08,
            R.mipmap.maolilan4_09, R.mipmap.maolilan4_10, R.mipmap.maolilan4_11, R.mipmap.maolilan4_12, R.mipmap.maolilan4_13,
            R.mipmap.maolilan4_14, R.mipmap.maolilan4_15, R.mipmap.maolilan4_16};
...
//            弹出提示用户成功的对话框
            ...
            builder.setPositiveButton("下一关", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(AnimateM10Activity.this, AnimateM11Activity.class);
